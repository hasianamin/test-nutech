						...
						<form action="<?php base_url(" admin/product/edit") ?>" method="post"
							...
							<input type="hidden" name="id" value="<?php echo $product->product_id?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    type="number" name="price_buy" min="0" placeholder="Product price" value="<?php echo $product->price_buy ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    type="number" name="price_sell" min="0" placeholder="Product price" value="<?php echo $product->price_sell ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    type="number" name="stock" min="0" placeholder="Product price" value="<?php echo $product->stock ?>" />
                                    <div class="invalid-feedback">
